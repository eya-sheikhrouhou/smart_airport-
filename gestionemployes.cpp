      ...
      ui(new Ui::gestionEmployes)
{
   ...
   // ui->label_logo4->setPixmap(pix.scaled(100,100,Qt::KeepAspectRatio));
    ...
    ui->comboBox_restos->addItem(QIcon("C:/Users/HP/Desktop/integration/smart_airport-/Burger-King-2021-1.jpg"),"BurgerKing");
    ui->comboBox_restos->addItem(QIcon("C:/Users/HP/Desktop/integration/smart_airport-/KFC logo.jpg"),"KFC");
    ui->comboBox_restos->addItem(QIcon("C:/Users/HP/Desktop/integration/smart_airport-/pizza-hut-logo"),"PizzaHut");
    ui->comboBox_restos->addItem(QIcon("C:/Users/HP/Desktop/integration/smart_airport-/Symbole-Starbucks (1).jpg"),"StarBucks");
    ui->comboBox_restos->addItem(QIcon("C:/Users/HP/Desktop/integration/smart_airport-/dunkindonuts (1).png"),"DunkinDonnuts");
    ui->comboBox_restos->addItem(QIcon("C:/Users/HP/Desktop/integration/smart_airport-/coffee-cup-logo-coffee-shop (1).jpg"),"CoffeeShop");
/////////////////////////////////////////////arduino////////////////////////////////////////////
